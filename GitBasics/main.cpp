#include "Header.h"
#include"Functions.cpp"//	Реализации шаблонных функций обязательно подключаются на место вызова!!!
//Реализации НЕшаблонных функций НИ В КОЕМ СЛУЧАЕ НЕ подключаются на место вызова
